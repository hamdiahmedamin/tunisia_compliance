...
frappe.tour["Accounting Journal"] = [
	{
		...
		description: __(
			"This is the label of this journal. It should be more explicit than the journal code."
		),
	},
	{
	...
	},
	{
		...
		description: __(
			"If the journal is a bank or cash journal, it should be linked to the corresponding bank or cash account."
		),
	},
	{
		fieldname: "disabled",
	...
	},
	{
		...
		description: __(
			"You can link your journal with specific transactions and add some conditions. E.g: Link it to a sales invoice with a condition `doc.is_return` for a credit notes journal."
		),
	},
];
